...
const EmailButton = () => {
  ...
  const handleChange = (event: React.ChangeEvent<HTMLInputElement>) => setEmailValue(event.target.value);
  return (
    <>
      <div>
        <div className="relative mb-6" data-te-input-wrapper-init>
          <input
            ...
            id="email"
            value={emailValue} onChange={handleChange}
        ...
        <button
          ...
          data-te-ripple-init
          onClick={() => void signIn("email", { email: emailValue, callbackUrl: "/projects" })}
