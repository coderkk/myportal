        ...
        utils.supplierInvoice.getSupplierInvoices.setData(
          ...
          (oldSupplierInvoices) => {
            const optimisticUpdateObject = {
              ...
              paid: values.paid, // OU FIX
              approved: values.approved, // OU FIX
          ...
          (oldSupplierInvoices) => {
            if (oldSupplierInvoices) {
              ...
              if (updatedSupplierInvoice) {
                ...
                updatedSupplierInvoice.paid = values.paid; // OU FIX
                updatedSupplierInvoice.approved = values.approved; // OU FIX
        ...
        utils.supplierInvoice.getSupplierInvoice.setData(
          ...
          (oldSupplierInvoice) => {
            if (oldSupplierInvoice) {
              ...
              newSupplierInvoice.paid = values.paid; // OU FIX
              newSupplierInvoice.approved = values.approved; // OU FIX
